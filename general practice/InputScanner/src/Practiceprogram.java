...
public class Practiceprogram {
	public static void main(String[] args) {
		 ...
		 */
		/*
		 * int[] arr = { 23, 34, 5, 67, 99, 100, 99 }; int max = Integer.MIN_VALUE; int
		 * second_max=Integer.MIN_VALUE; for(int num:arr) { if(num>max) { max=num; }
		 * else { continue; } } System.out.println(max);
		 */
